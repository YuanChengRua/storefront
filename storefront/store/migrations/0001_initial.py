...
# migration just like git, we can go back to each version of our project and the later migration will
# depend on the previous one
# this migration is just create all the data model
# when we finish building the migration, we can use python manage.py migrate to execute all the operations
# in the migration
# and we can just use migration to control the change of the project instead of writing code
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_atus', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], default='P', max_length=1)),
